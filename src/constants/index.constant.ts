import { courseTable, examTable, fileTable, governorateTable, instructorTable, linkTable, playlistTable, regionTable, subjectTable, userTable, videoTable, yearTable } from "@/lib/db/schema";
...
export const curriculums = {
    flat: [
        { labelAr: 'الامتحانات الانجليزية', labelEn: 'English Exams', value: 'englishExam' },
    ],
    nested: {
        school: [
            { labelAr: 'المرحلة الابتدائية', labelEn: 'Primary School', value: 'primary' },
            { labelAr: 'المرحلة الثانوية', labelEn: 'Secondary School', value: 'secondary' },
        ]
    }
};
